package s6.moderatorservice.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s6.moderatorservice.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s6.moderatorservice.configuration.security.isauthenticated.IsAuthenticated)")
